...
function List({ children, className }: { children: JSX.Element[] | JSX.Element, className?: string }) {
    return (
...
export const ListRow = ({ children, className }: { children: JSX.Element[] | JSX.Element, className?: string }) => {
    return (
