...
function ProfileDetail({ handleModal, title }: { handleModal: (state: boolean) => void; title?: string }) {
    const {
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    {<h1 className="mb-4 text-xl font-bold">{title || (user?.id !== "" ? "Update User" : "Create User")}</h1>}
